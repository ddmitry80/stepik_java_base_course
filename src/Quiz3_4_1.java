final class ComplexNumber {
    ...
    public boolean equals(Object obj) {
        ...
        ComplexNumber guest = (ComplexNumber) obj;
        if ((this.re==guest.getRe()) && (this.im==guest.getIm())) {
            return true;
        } else {
            return false;
        }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 31*String.valueOf(re).hashCode()*String.valueOf(im).hashCode();
        return hash;
    }
}

public class Quiz3_4_1 {
